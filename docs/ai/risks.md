...
## R-43 · `notFound()` ב-loader של השרת הופך רענון ל-HTTP 404 — 🟡 Medium (הוסף 2026-09-20 ערב)
...
**נותר:** `treadmills.$id`, `locations.$id`, `exercises.$id` (loader) — אותה תבנית, מחוץ להיקף ה-PR. תיקון זהה של 2 שורות לכל מסלול.
